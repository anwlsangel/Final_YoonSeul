...
<body>
	...
	<div class="outer">
			...
			<div id="title-area" style="margin-top: 100px;">
				...
				<div class="booking-area" align="center">
					...
					<div id="seatDiv" class="row"
						style="border: 1px solid black; width: 80%" align="center">




						<div id="howManyticket" class="col-6">시간을 선택해주세요</div>
						<div id="priceSummaryDiv" class="col-6" align="center">


							<div>
								<span id="ticketNum">0</span>장/<span for="totalPrice">총
									가격 : </span><span id="totalPrice">0</span><span>원</span>
								<button id="clear"
									style="color: white; background-color: #810000;"
									onclick="removeAll()" type="reset">초기화</button>
							</div>
							<input type="hidden" name="concertId" id="concertId"
								value="${param.cno}"> <input type="hidden"
								name="ticketQuantity" id="ticketQuantity" value="0"> <input
								type="hidden" name="totalPrice" id="totalPriceInput" value="0">
						</div>
        ...
        function pickTime(day,id,time){
            ...
            document.getElementById("howManyticket").innerHTML=appendString;
            ticketQuantity=0;
    ...
    <!-- 좌석관련 스크립트-->
        ...
        function removeAll() {
            numOfTicket = 0;
            $("#ticketNum").html(numOfTicket);
            $("#howManyticket").html("시간을 선택해주세요")
		...
		function payment(buylistId) {
			...
			const myAmount = ticketPrice * ticketQuantity; //총 결제금액
